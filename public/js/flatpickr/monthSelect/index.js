        ...
        return function(fp) {
            ...
            function addMonths() {
                ...
                for (var i = 0; i < 12; i++) {
                    ...
                    if (
                        (fp.config.minDate &&
                            month.dateObj < fp.config.minDate) ||
            ...
            function setCurrentlySelected() {
                ...
                var month = fp.rContainer.querySelector(
                    ".flatpickr-monthSelect-month:nth-child(" +
                        (targetMonth + 1) +
                        ")"
                );
                if (month) {
                    ...
                    months.forEach(function(month) {
                        ...
                        if (
                            (fp.config.minDate &&
                                month.dateObj < fp.config.minDate) ||
                            (fp.config.maxDate &&
                                month.dateObj > fp.config.maxDate)
                        ) {
                            month.classList.add("disabled");
                        } else {
            ...
            function onKeyDown(_, __, ___, e) {
                ...
                if (index === -1) {
                    var target =
                        currentlySelected ||
                        self.monthsContainer.firstElementChild;
                    target.focus();
                    index = target.$i;
                }
                if (shouldMove) {
