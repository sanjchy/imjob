(function(h) {
    ...
    n.ext = x = {
        buttons: {},
        classes: {},
        builder: "bs4/dt-1.10.18/b-1.5.6/sc-2.0.0/sl-1.3.0",
        errMode: "alert",
        feature: [],
        search: [],
...
(function(d) {
                ...
                if (v)
                    if (d.isArray(v)) this._expandButton(a, v, c, e);
                        ...
                        if (m) {
                            ...
                            v.init &&
                                v.init.call(f.button(m.node), f, d(m.node), v);
                            g++;
                        }
                    }
            }
                ...
                f = function(a, b) {
                    ...
                    if (d.isArray(a) || a instanceof d)
                        ...
                        if (-1 !== a.indexOf(","))
                            ...
                            for (
                                a = a.replace(":name", ""), k = 0, g = h.length;
                                k < g;
                                k++
                            )
                                h[k].name === a &&
        ...
        collection: {
            ...
            action: function(a, b, c, e) {
                ...
                if (!a) {
                    ...
                    e.background &&
                        t.background(!0, e.backgroundClassName, e.fade, l);
                    setTimeout(function() {
    ...
    p.Api.registerPlural("buttons().active()", "button().active()", function(
        a
    ) {
        return a === l
            ? this.map(function(a) {
    ...
    p.Api.registerPlural("buttons().action()", "button().action()", function(
        a
    ) {
        return a === l
            ? this.map(function(a) {
                ...
                h =
                    ...
                    a.fnRecordsDisplay() == a.fnRecordsTotal()
                        ...
                        : b.sInfo
                          ...
                          b.sInfoPostFix;
                (b = b.fnInfoCallback) &&
                    (h = b.call(a.oInstance, a, e, c, f, g, h));
                e = a.aanFeatures.i;
