...
<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
    <div class="card mb-4 shadow-none">
        <div class="card-header p-1 m-0 d-flex justify-content-between">
            <h5 class="py-2 px-3 my-0 font-weight-bold">Professional Skills</h5>
            <a class="d-none py-2 px-2" data-toggle="modal" data-target="#addSkill">
                <i class="fi-rr-add fa-lg text-success"></i>
            </a>
            @include('candidate.inc.modals.profile.professional')
        </div>
        <div class="card-body">
            <div class="row">
