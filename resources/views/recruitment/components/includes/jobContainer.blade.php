<div class="container-fluid border p-0 rounded m-0" class="max-height">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="align-middle text-left pt-1">
                                                                    <p
                                                                        ...
                                                                        ucwords($job->candidateEducation) :
                                                                        "Not Defined" !!}
                                                                    </p>
                                                                    <span class="m-0 p-0 d-flex justify-content-start">
                                                                        <span class="d-flex justify-content-start">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="align-middle text-left pt-1">
                                                                    <p
                                                                        ...
                                                                        $job->candidateWorkExperience : "Not
                                                                        Defined" !!}
                                                                    </p>
                                                                    <span class="m-0 p-0 d-flex justify-content-start">
                                                                        <span class="d-flex justify-content-start">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="align-middle text-left pt-1">
                                                                    <p
                                                                        ...
                                                                        $job->candidateOtherLanguage : "Not
                                                                        Defined" !!}
                                                                    </p>
                                                                    <span class="m-0 p-0 d-flex justify-content-start">
                                                                        <span class="d-flex justify-content-start">
                                            ...
                                            <div class="container-fluid">
                                                <div class="row">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="my-1">
                                                            <div
                                                                class="p-0 m-0 d-flex justify-content-between text-center">
                                                                <p
                                                                    class="p-0 m-0 font-weight-bold d-flex justify-content-start">
