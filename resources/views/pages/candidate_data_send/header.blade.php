<div class="page-template-page-form">
    <header>
                ...
                <div class="container">
                    <nav
                        ...
                        <button class="navbar-toggler" type="button" data-toggle="collapse"
                            data-target="#navbarheadertop" aria-controls="navbarheadertop" aria-expanded="false"
                        ...
                        <div id="navbarheadertop" class="collapse navbar-collapse">
                            <ul id="menu-main-menu" class="navbar-nav ml-auto">
                                ...
                                <li id="menu-item-wpml-ls-2-en"
                                    ...
                                    <a title="English" href="{{ route('home', app()->getLocale()) }}"
                                        class="nav-link dropdown-toggle" data-toggle="dropdown">
                                        <img class="wpml-ls-flag"
                                            src="{{ asset('storage/flags/en.png') }}"
                                            alt="">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a title="Italian" href="{{ url('/it/'. \Request::route()->getName()) }}"
                                            class="menu-item dropdown-item">
                                            <img class="wpml-ls-flag"
                                                src="{{ asset('storage/flags/it.png') }}"
                                                alt="">
                                        ...
                                        <a title="Serbian" href="{{ url('/rs/'. \Request::route()->getName()) }}"
                                            class="menu-item dropdown-item">
                                            <img class="wpml-ls-flag"
                                                src="{{ asset('storage/flags/sr.png') }}"
                                                alt="">
                                    ...
                                    <div class="dropdown-menu">
                                        <a title="English" href="{{ url('/en/'. \Request::route()->getName()) }}"
                                            class="menu-item dropdown-item">
                                            <img class="wpml-ls-flag"
                                            src="{{ asset('storage/flags/en.png') }}"
                                            alt="">
                                    ...
                                    <a title="Serbian" href="{{ route('home', app()->getLocale()) }}"
                                        class="nav-link dropdown-toggle" data-toggle="dropdown">
                                        <img class="wpml-ls-flag"
                                            src="{{ asset('storage/flags/sr.png') }}"
                                            alt="">
                                    ...
                                    <div class="dropdown-menu">
                                        <a title="Italian" href="{{ url('/en/'. \Request::route()->getName()) }}"
                                            class="menu-item dropdown-item">
                                            <img class="wpml-ls-flag"
                                                src="{{ asset('storage/flags/en.png') }}"
                                                alt="">
                                        ...
                                        <div class="dropdown-menu">
                                            <a title="Italian"
                                                ...
                                                class="menu-item dropdown-item">
                                                <img class="wpml-ls-flag" src="{{ asset('storage/flags/it.png') }}"
                                                    alt="">
                                            ...
                                            <a title="Serbian"
                                                ...
                                                class="menu-item dropdown-item">
                                                <img class="wpml-ls-flag" src="{{ asset('storage/flags/sr.png') }}"
                                                    alt="">
                                                <span class="wpml-ls-native" lang="sr">српски</span>
                                                <span class="wpml-ls-display">
                                                    <span class="wpml-ls-bracket"> (</span>Serbian<span
